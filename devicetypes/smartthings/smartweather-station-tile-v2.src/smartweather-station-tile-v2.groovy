...
metadata {
	...
	tiles {
        ...
        valueTile("windDir", "device.windDir", decoration: "flat") {
			state "default", label:'winddir ${currentValue}'
		}
		...
		details(["temperature", "weatherIcon", "city", "feelsLike", "humidity", "weather", "percentPrecip", "wind", "windDir", "refresh", "alert", "rise", "set", "light"])}
}
