...
metadata {
	...
	definition (name: "My Z-Wave Door/Window Sensor - Doorbell - Front", namespace: "jscgs350", author: "SmartThings") {
	...
	tiles {
		standardTile("contact", "device.contact", width: 2, height: 2) {
			state "open", label: ".....", icon: "st.Home.home30", backgroundColor: "#B0E0E6"
...
def sensorValueEvent(value) {
	if (value) {
    	log.debug "Front doorbell is now waiting to be pressed again..."
		createEvent(name: "contact", value: "open", descriptionText: "$device.displayName is waiting")
    } else {
    	log.debug "Front doorbell was just pressed..."
		createEvent(name: "contact", value: "closed", descriptionText: "$device.displayName was pressed")
	}
}
